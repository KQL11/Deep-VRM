...
class MLLMTemplateType:
    ...
    # NOTE:
    my_qwen2_5_vl = 'my_qwen2_5_vl'  # custom version without bbox normalization and post encoding
    my_qwen2_5_vl_expert = 'my_qwen2_5_vl_expert'
    my_ovis2_5 = 'my_ovis2_5'
    my_qwen2_vl = 'my_qwen2_vl' 
    my_llava = 'my_llava' 
